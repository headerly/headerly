...
import { Skeleton } from "@headerly/ui/components/skeleton";
import { useUiLabels } from "@headerly/ui/lib/labels";
      ...
      >
        ...
        >
          ...
          <ComboboxInput v-model="query" as-child>
            <TagsInputInput
              :placeholder="modelValue.length > 0 ? '' : props.placeholder || labels.selectOptions"
              class="
